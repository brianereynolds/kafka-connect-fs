...
public class FsSourceTaskConfig extends FsSourceConnectorConfig {
    ...
    public static final String OFFSET_STORAGE = POLICY_PREFIX + "offset.storage";
    private static final String OFFSET_STORAGE_DOC = "Offset storage location; either in kakfa (default) or within the connector";
    ...
    public static ConfigDef conf() {
        return FsSourceConnectorConfig.conf()
                ...
                .define(OFFSET_STORAGE, ConfigDef.Type.STRING, "context", ConfigDef.Importance.MEDIUM, OFFSET_STORAGE_DOC);
    }
